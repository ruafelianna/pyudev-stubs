...
class DeviceNotFoundByNameError(DeviceNotFoundError):
    def __init__(self, subsystem : str, sys_name : str): ...
...
class DeviceNotFoundByNumberError(DeviceNotFoundError):
    def __init__(self, typ : Literal["char", "block"] , number : int): ...
...
class DeviceValueError(DeviceError):
    def __init__(self, value : object, param : str, msg : str | None = None): ...
